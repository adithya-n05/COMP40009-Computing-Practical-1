...
public class Tests {
  ...
  public void testQuestion1() {
    ...
    try {
      ...
      throw new RuntimeException(
          "Expected IllegalArgumentException on attempt to create "
              + "empty matrix");
  ...
  public void testQuestion3() {
    ...
    final Matrix<Boolean> booleanMatrix1 = new Matrix<>(
        Arrays.asList(true, false, false, false, true, false, false, false,
            true));
    final Matrix<Boolean> booleanMatrix2 = new Matrix<>(
        Arrays
            .asList(true, false, true, false, true, false, true, true, false));
    ...
    final Matrix<Boolean> booleanMatrixProduct =
        booleanMatrix1
            .product(booleanMatrix2, Boolean::logicalOr, Boolean::logicalAnd);
  ...
  public void testQuestion4() {
    ...
    assertEquals(new Integer(2416),
        productOfPairMatrices.get(0, 0).getCoordX());
    assertEquals(new Integer(-2416),
        productOfPairMatrices.get(0, 0).getCoordY());
    assertEquals(new Integer(2889),
        productOfPairMatrices.get(0, 1).getCoordX());
    assertEquals(new Integer(-2889),
        productOfPairMatrices.get(0, 1).getCoordY());
    assertEquals(new Integer(9424),
        productOfPairMatrices.get(1, 0).getCoordX());
    assertEquals(new Integer(-9424),
        productOfPairMatrices.get(1, 0).getCoordY());
    assertEquals(new Integer(11269),
        productOfPairMatrices.get(1, 1).getCoordX());
    assertEquals(new Integer(-11269),
        productOfPairMatrices.get(1, 1).getCoordY());
