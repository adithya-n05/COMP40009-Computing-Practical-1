...
public class AABB {
   ...
   */
  public synchronized double left() {
    return left;
  }
   ...
   */
  public synchronized double right() {
    return right;
  }
   ...
   */
  public synchronized double bottom() {
    return bottom;
  }
   ...
   */
  public synchronized Point2D topLeft() {
   ...
   */
  public synchronized Point2D bottomRight() {
   ...
   */
  public synchronized Point2D topRight() {
   ...
   */
  public synchronized Point2D bottomLeft() {
    return new Point2D(left, bottom);
  }

  /*
   * Returns true if and only if the given point is in the region.
   * @param p the given point to look for in the region
   */
  public synchronized boolean covers(Point2D p) {
