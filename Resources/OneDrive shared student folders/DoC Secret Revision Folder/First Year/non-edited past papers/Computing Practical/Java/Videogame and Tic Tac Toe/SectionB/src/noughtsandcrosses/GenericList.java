...
public class GenericList<T> implements GenericListInterface<T> {
  ...
  public T get(int pos) throws ListIndexOutOfBoundsException {
    if (pos >= 1 && pos <= numItems) {
      ...
      throw new ListIndexOutOfBoundsException(
          "position out of range in get method of a list"
      );
    }
  } // end get

  //post: Adds the given item at the given position in the list.
  ...
  //post: Removes the item at the given position in the list.
  //      It throws an exception if the position is out of bounds.
  public void remove(int pos) throws ListIndexOutOfBoundsException {
    if (pos >= 1 && pos <= numItems) {
      ...
      throw new ListIndexOutOfBoundsException(
          "position out of range in remove method of a list");
    }
  } //end remove
