public class BinaryTree<K extends Comparable<K>> implements
    BinaryTreeInterface<K> {
  ...
  public BinaryTree(K rootData, BinaryTree<K> leftTree,
      BinaryTree<K> rightTree) {
    // Constructor
  ...
  public BinaryTree<K> getLeftSubtree() {
    if (root != null && root.left != null) {
      BinaryTree<K> temp = new BinaryTree<>(root.left);
      return temp;
    } else {
      return null;
    }
  ...
  public BinaryTree<K> getRightSubtree() {
    if (root != null && root.right != null) {
      BinaryTree<K> temp = new BinaryTree<>(root.right);
      return temp;
    } else {
      return null;
    }
