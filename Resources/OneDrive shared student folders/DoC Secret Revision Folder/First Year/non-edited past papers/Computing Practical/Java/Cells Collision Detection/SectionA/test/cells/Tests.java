...
public class Tests {
  ...
  private static void reportExceptionShouldHaveBeenThrown() {
    throw new RuntimeException(
        "UnsupportedOperationException should have been thrown");
  }
  ...
  public void testQuestion1() {
    ...
    assertTrue(stringCell.isSet());
    MutableCell<MutableCell<Integer>> nestedIntegerCell
        = new MutableCell<>(new MutableCell<>(20));
  ...
  public void testQuestion2() {
    ...
    Exception anException
        = new Exception("An exception to be wrapped in a cell");
    ...
    final ImmutableCell<ImmutableCell<Integer>> nested1
        = new ImmutableCell<>(i1);
    final ImmutableCell<ImmutableCell<Integer>> nested2
        = new ImmutableCell<>(i2);
    final ImmutableCell<ImmutableCell<Integer>> nested3
        = new ImmutableCell<>(i3);
