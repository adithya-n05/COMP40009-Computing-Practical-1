...
public class Progress {
  ...
  private static void testQuestion2() throws DeadlockException {
    ...
    }
    {
      try {
        ...
        System.out
            .println("MISMATCH: DeadlockException should have been thrown");
        mismatches++;
  ...
  private static void testQuestion3() {
    ...
    System.out.println("================");
    {
      String result = new Executor(
          makeExampleProgram(), new RoundRobinScheduler()
      ).execute();
    ...
    {
      String result = new Executor(
          makeExampleProgram2(), new RoundRobinScheduler()
      ).execute();
      checkExpectedVersusActual(
    ...
    {
      String result = new Executor(
          makeExampleProgram3(), new RoundRobinScheduler()
      ).execute();
      checkExpectedVersusActual(
          "Final state: [x -> 0]\n"
              + "History: []\n"
  ...
  private static void testQuestion4() {
    ...
    {
      String result = new Executor(
          makeExampleProgram2(), new FewestWaitsScheduler()
      ).execute();
      checkExpectedVersusActual(
          "Final state: [x -> 1, y -> 1, z -> 1]\n"
              + "History: [3, 2, 2, 1, 1, 0]\n"
    ...
    {
      String result = new Executor(
          makeExampleProgram3(), new FewestWaitsScheduler()
      ).execute();
      checkExpectedVersusActual(
          "Final state: [x -> 0]\n"
              + "History: []\n"
    ...
    {
      String result = new Executor(
          makeExampleProgram4(), new FewestWaitsScheduler()
      ).execute();
      checkExpectedVersusActual(
          "Final state: [x -> 0, y -> 3]\n"
